...
// Funciones
struct InformacionCantante SolicitarDatos(); // Se hace una funcion struct pq se solicitaran varios datos
...
struct InformacionCantante SolicitarDatos()
{
    ...
    datos.inf_album.antiguedad_album = CalcularAntiguedad(datos.inf_album.ano_lanzamiento);
